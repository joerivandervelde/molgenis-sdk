...
public class ImportLvVsNilv
{
	...
	{
		String patientsFile = "/Users/pdopheide/Desktop/lv_vs_nilv_test.txt";
	...
	private static void importPatients(String patientsFile) throws DatabaseException, IOException{
		...
		entitiesImporter.importEntities(csvReader, "LvVsNilvAnnotedGenes", DatabaseAction.ADD);
		csvReader.close();
